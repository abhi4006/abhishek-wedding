  ...
  return (
    <main className="invitation-page">
      ...
      <motion.article
        ...
        aria-label="अभिषेक के परिवार की ओर से विवाह निमंत्रण"
      >
        <ShehnaiPlayer />
        ...
        >
          <motion.header variants={fadeUp} className="invitation-header">
            ...
            <p className="invitation-copy">
              ईश्वर की असीम कृपा से हमारे सुपुत्र अभिषेक के मंगल परिणय पर
              <br />
          ...
          <motion.section variants={fadeUp} className="couple">
            <div className="person">
              <h2>अभिषेक</h2>
              <p>
                सुपुत्र श्रीमती मीना
                <br />
                एवं श्री वेद पाल सिंह
              </p>
            </div>
